<template>
        <div class="searchBox">
            <input @keyup.enter="inputChanged" v-model="inputVModel" class="searchInput" type="text" name="" placeholder="Search something">
            <button @click="inputChanged" class="searchButton colorfull-gradient-1" href="#">
...
export default{
    ...
    methods : {
        inputChanged(){
            this.$emit("input-changed",this.inputVModel);
        }
    }
}
</script>
