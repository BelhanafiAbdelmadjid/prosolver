...
app.config['SESSION_COOKIE_DOMAIN'] = '192.168.1.23'
...
app.config["SQLALCHEMY_DATABASE_URI"] = 'mysql+mysqlconnector://{user}:{password}@{server}/{database}'.format(user='root', password='madjid123', server='127.0.0.1:3306', database='banxyincidentsdb')

app.config["LDAP_SERVER"] ="ldap://192.168.1.56:389"
